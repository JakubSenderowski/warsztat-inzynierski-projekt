...
function UnitOfMeasureAddPage() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await api.post('/api/units-of-measure', data);
			...
			<div className='flex justify-center items-start min-h-screen px-6 pt-12'>
				<div className='bg-[#101935] rounded-xl p-8 w-full max-w-[700px]'>
					<div className='mb-8 text-center'>
						<h1 className='text-2xl text-white font-medium'>Dodaj jednostkę miary</h1>
						<p className='text-sm text-white/60 mt-1'>Utwórz nową jednostkę</p>
					</div>
					...
					<form onSubmit={handleSubmit} className='space-y-4'>
						...
						<button
							...
							Utwórz jednostkę <FaRuler size={18} />
						</button>
					</form>
				</div>
			</div>
...
export default UnitOfMeasureAddPage;
