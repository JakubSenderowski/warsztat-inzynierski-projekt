			...
			<div className='flex justify-center items-start min-h-screen px-6 pt-12'>
				<div className='bg-[#101935] rounded-xl p-8 w-full max-w-[700px]'>
					<div className='mb-8 text-center'>
						<h1 className='text-2xl text-white font-medium'>Dodaj wycenę</h1>
						<p className='text-sm text-white/60 mt-1'>Utwórz nową ofertę dla klienta</p>
					</div>
					...
					<form onSubmit={handleSubmit} className='space-y-4'>
						...
						<button
							...
							Utwórz wycenę <FaFileContract size={18} />
						</button>
					</form>
				</div>
			</div>
